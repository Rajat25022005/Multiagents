...
from backend.admin.manager import AgentManager
from backend.admin.spawner import AgentSpawner, AgentType
from backend.admin.security import SecurityValidator, SecurityLevel
from backend.processing.result_processor import ResultProcessor
from backend.actions.finalizer import FinalizerAgent
from backend.actions.file_manager import FileManager

from backend.core.llm_router import LLMRouter
from backend.agents.vision import VisionAgent
from backend.agents.graph_memory import GraphMemory
import os
...
class OrchestratorEngine:
    ...
    def _verify_and_heal(self, file_manager: FileManager, result_processor: ResultProcessor, max_retries: int = 3):
        from backend.actions.environment_manager import EnvironmentManager
    ...
    def _execute_plan(self, plan):
        from backend.actions.web_scraper import WebScraper
